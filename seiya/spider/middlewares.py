    ...
    def process_request(self, request, spider):
        ...
        if spider.name == 'jobs':
            ...
            if ua:
                ...
                request.headers.setdefault('Cookie', 's_ViewType=10; _lxsdk_cuid=16de312a634c8-0a3aa8d57369a9-3c375f0d-1fa400-16de312a634c8; _lxsdk=16de312a634c8-0a3aa8d57369a9-3c375f0d-1fa400-16de312a634c8; _hc.v=f4b94487-928f-aeb3-f3ab-0d213fbefd6a.1571472713; _lxsdk_s=16de312a636-86e-a59-386%7C%7C40')
